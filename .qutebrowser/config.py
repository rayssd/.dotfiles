...
## Type: Int
c.colors.webpage.darkmode.threshold.background = 205 #was 100
...
## Type: Int
c.colors.webpage.darkmode.threshold.text = 150 # was 150
...
c.content.user_stylesheets = ['/Users/ray/.qutebrowser/customCSS/darkmode.css']
# c.content.user_stylesheets = ['customCSS/solarized-everything-css/css/darculized/darculized-all-sites.css']
...
## default is used.
## Type: Directory
c.downloads.location.directory = "~/Cases/"
...
# c.editor.command = ['/Applications/Alacritty.app/Contents/MacOS/alacritty', '-e', '/bin/zsh', '-lc', 'hx {file}'] 
...
config.bind('<Ctrl-Shift-U>', 'spawn --userscript bitwarden.py -u')
config.bind('<Ctrl-Shift-P>', 'spawn --userscript bitwarden.py -p')
